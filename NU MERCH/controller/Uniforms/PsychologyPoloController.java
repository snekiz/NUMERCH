...
public class PsychologyPoloController implements Initializable{
    private Stage stage;
    private Scene scene;
    private Parent root;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        stock.setText(Integer.toString(ChoicepageController.PP.getProductStocks()));
 ...
 if (sizeChoicebox.getValue().equals("Please select sizes") || styleChoicebox.getValue().equals("Please select styles")) {
        ...
        ChoicepageController.cartcontroller.addItemR(ChoicepageController.cartcontroller.RightPane1);
    ...
    public void getsizechoice(ActionEvent event){
        ...
        ChoicepageController.PP.setProductsize(sizechoice);
    ...
    public void getStylechoice(ActionEvent event){
        ...
        calculateProductPrice();
        ChoicepageController.PP.setProductstyle(stylechoice);
    }

    private void calculateProductPrice(){
        if (stylechoice == "M"){
            if (sizechoice == "XS" || sizechoice == "S" || sizechoice == "M"){
            ChoicepageController.PP.setProductPrice(570.0);
            price = Double.toString(ChoicepageController.PP.getProductPrice());
            DecimalFormat decimalFormat = new DecimalFormat("#0.00");
            price = decimalFormat.format(ChoicepageController.PP.getProductPrice());
            PriceLBL.setText("\u20B1"+price);
        }
            else if(sizechoice == "L" || sizechoice == "XL" || sizechoice == "2XL" || sizechoice == "3XL"){
            ChoicepageController.PP.setProductPrice(600.0);
            price = Double.toString(ChoicepageController.PP.getProductPrice());
            DecimalFormat decimalFormat = new DecimalFormat("#0.00");
            price = decimalFormat.format(ChoicepageController.PP.getProductPrice());
            PriceLBL.setText("\u20B1"+price);
            ...
            ChoicepageController.PP.setProductPrice(800.0);
            price = Double.toString(ChoicepageController.PP.getProductPrice());
            DecimalFormat decimalFormat = new DecimalFormat("#0.00");
            price = decimalFormat.format(ChoicepageController.PP.getProductPrice());
            PriceLBL.setText("\u20B1"+price);
 ...
 public void toPants(ActionEvent event)throws IOException{
     ...
     scene.getStylesheets().add(getClass().getResource("/css/krazy.css").toExternalForm());
     stage.show();
     System.out.println(ChoicepageController.PP.getProductPrice());
 }
...
public void toCart(ActionEvent event)throws IOException{
    ...
    public void buy(ActionEvent event)throws IOException{
        ...
        ChoicepageController.PP.setProductStatus(true);
        ChoicepageController.PP.setProductQuantity(1);
