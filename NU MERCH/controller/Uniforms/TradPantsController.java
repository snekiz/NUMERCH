...
public class TradPantsController implements Initializable{
    private Stage stage;
    private Scene scene;
    private Parent root;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        stock.setText(Integer.toString(ChoicepageController.TPants.getProductStocks()));
 ...
 if (sizeChoicebox.getValue().equals("Please select sizes") || styleChoicebox.getValue().equals("Please select styles")) {
        ...
        ChoicepageController.cartcontroller.addItemL(ChoicepageController.cartcontroller.LeftPane2);
    ...
    public void getsizechoice(ActionEvent event){
        ...
        ChoicepageController.TPants.setProductsize(sizechoice);
    ...
    public void getStylechoice(ActionEvent event){
        ...
        calculateProductPrice();
        ChoicepageController.TPants.setProductstyle(stylechoice);
    }

    private void calculateProductPrice(){
        if (stylechoice == "M"){
            if (sizechoice == "XS" || sizechoice == "S" || sizechoice == "M"){
            ChoicepageController.TPants.setProductPrice(440.0);
            price = Double.toString(ChoicepageController.TPants.getProductPrice());
            DecimalFormat decimalFormat = new DecimalFormat("#0.00");
            price = decimalFormat.format(ChoicepageController.TPants.getProductPrice());
            PriceLBL.setText("\u20B1"+price);

        }
            else if(sizechoice == "L" || sizechoice == "XL" || sizechoice == "2XL" || sizechoice == "3XL"){
            ChoicepageController.TPants.setProductPrice(470.0);
            price = Double.toString(ChoicepageController.TPants.getProductPrice());
            DecimalFormat decimalFormat = new DecimalFormat("#0.00");
            price = decimalFormat.format(ChoicepageController.TPants.getProductPrice());
            PriceLBL.setText("\u20B1"+price);
            ...
            ChoicepageController.TPants.setProductPrice(700.0);
            price = Double.toString(ChoicepageController.TPants.getProductPrice());
             DecimalFormat decimalFormat = new DecimalFormat("#0.00");
            price = decimalFormat.format(ChoicepageController.TPants.getProductPrice());
            PriceLBL.setText("\u20B1"+price);
...
public void Reserve(ActionEvent event)throws IOException{
 ...
 public void toPants(ActionEvent event)throws IOException{
     ...
     scene.getStylesheets().add(getClass().getResource("/css/krazy.css").toExternalForm());
     stage.show();
     System.out.println(ChoicepageController.TPants.getProductPrice());
 }
...
public void toHelp(ActionEvent event)throws IOException{
  ...
  public void toCart(ActionEvent event)throws IOException{
    ...
    public void buy(ActionEvent event)throws IOException{
        ...
        ChoicepageController.TPants.setProductStatus(true);
        ChoicepageController.TPants.setProductQuantity(1);
