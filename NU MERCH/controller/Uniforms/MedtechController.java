...
public class MedtechController implements Initializable{
    private Stage stage;
    private Scene scene;
    private Parent root;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        stock.setText(Integer.toString(ChoicepageController.MP.getProductStocks()));
 ...
 if (sizeChoicebox.getValue().equals("Please select sizes") || styleChoicebox.getValue().equals("Please select styles")) {
        ...
        ChoicepageController.cartcontroller.addItemR(ChoicepageController.cartcontroller.RightPane3);
    ...
    public void getsizechoice(ActionEvent event){
        ...
        ChoicepageController.MP.setProductsize(sizechoice);
    ...
    public void getStylechoice(ActionEvent event){
        ...
        calculateProductPrice();
        ChoicepageController.MP.setProductstyle(stylechoice);
    ...
    private void calculateProductPrice(){
        if (stylechoice == "M"){
            ...
            ChoicepageController.MP.setProductPrice(570.0);
            price = Double.toString( ChoicepageController.MP.getProductPrice());
            DecimalFormat decimalFormat = new DecimalFormat("#0.00");
            price = decimalFormat.format( ChoicepageController.MP.getProductPrice());
            PriceLBL.setText("\u20B1"+price);
        }
            else if(sizechoice == "L" || sizechoice == "XL" || sizechoice == "2XL" || sizechoice == "3XL"){
            ChoicepageController.MP.setProductPrice(600.0);
            price = Double.toString( ChoicepageController.MP.getProductPrice());
            DecimalFormat decimalFormat = new DecimalFormat("#0.00");
            price = decimalFormat.format( ChoicepageController.MP.getProductPrice());
            PriceLBL.setText("\u20B1"+price);
            ...
            ChoicepageController.MP.setProductPrice(800.0);
            price = Double.toString(ChoicepageController.MP.getProductPrice());
            DecimalFormat decimalFormat = new DecimalFormat("#0.00");
            price = decimalFormat.format(ChoicepageController.MP.getProductPrice());
            PriceLBL.setText("\u20B1"+price);
    ...
    public void toPants(ActionEvent event)throws IOException{
        ...
        scene.getStylesheets().add(getClass().getResource("/css/krazy.css").toExternalForm());
        stage.show();
        System.out.println(ChoicepageController.MP.getProductPrice());
    }
    ...
    public void buy(ActionEvent event)throws IOException{
        ...
        ChoicepageController.MP.setProductStatus(true);
        ChoicepageController.MP.setProductQuantity(1);
