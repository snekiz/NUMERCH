...
public class TradPoloController implements Initializable {
    private Stage stage;
    private Scene scene;
    private Parent root;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        stock.setText(Integer.toString(ChoicepageController.TP.getProductStocks()));
 ...
 if (sizeChoicebox.getValue().equals("Please select sizes") || styleChoicebox.getValue().equals("Please select styles")) {
        ...
        ChoicepageController.cartcontroller.addItemL(ChoicepageController.cartcontroller.LeftPane1);
    ...
    public void getsizechoice(ActionEvent event){
        ...
        ChoicepageController.TP.setProductsize(sizechoice);
    }

    public void getStylechoice(ActionEvent event){
        stylechoice = styleChoicebox.getValue();
        calculateProductPrice();
        ChoicepageController.TP.setProductstyle(stylechoice);
    ...
    private void calculateProductPrice(){
        ...
        if (stylechoice == "M"){
            ...
            ChoicepageController.TP.setProductPrice(520.00);
            price = Double.toString(ChoicepageController.TP.getProductPrice());
            DecimalFormat decimalFormat = new DecimalFormat("#0.00");
            price = decimalFormat.format(ChoicepageController.TP.getProductPrice());
            PriceLBL.setText("\u20B1"+price);
        }
            else if(sizechoice == "L" || sizechoice == "XL" || sizechoice == "2XL" || sizechoice == "3XL"){
            ChoicepageController.TP.setProductPrice(560.00);
            price = Double.toString(ChoicepageController.TP.getProductPrice());
            DecimalFormat decimalFormat = new DecimalFormat("#0.00");
            price = decimalFormat.format(ChoicepageController.TP.getProductPrice());
            PriceLBL.setText("\u20B1"+price);
            ...
            ChoicepageController.TP.setProductPrice(700.00);
            price = Double.toString(ChoicepageController.TP.getProductPrice());
            DecimalFormat decimalFormat = new DecimalFormat("#0.00");
            price = decimalFormat.format(ChoicepageController.TP.getProductPrice());
            PriceLBL.setText("\u20B1"+price);
        ...
        if (sizechoice == "XS" || sizechoice == "S" || sizechoice == "M"){
            ChoicepageController.TP.setProductPrice(500.00);
            price = Double.toString(ChoicepageController.TP.getProductPrice());
            DecimalFormat decimalFormat = new DecimalFormat("#0.00");
            price = decimalFormat.format(ChoicepageController.TP.getProductPrice());
            PriceLBL.setText("\u20B1"+price);
    ...
    public void toPants(ActionEvent event)throws IOException{
        ...
        scene.getStylesheets().add(getClass().getResource("/css/krazy.css").toExternalForm());
        stage.show();
        System.out.println(ChoicepageController.TP.getProductPrice());
    ...
    public void buy(ActionEvent event)throws IOException{
        ...
        ChoicepageController.TP.setProductStatus(true);
        ChoicepageController.TP.setProductQuantity(1);
